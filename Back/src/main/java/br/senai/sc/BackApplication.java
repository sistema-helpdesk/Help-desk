...
public class BackApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Empresa empresa2 = new Empresa(null, "Intelbrás");
		...
		Chamado chamado1 = new Chamado(null, setor1.getErro1(), "O sistema é horrível. Eu exijo uma atualização geral e total. dá um jeito! Não aguento mais! Não consigo cadastrar novos funcionários.", "Em andamento", null, empresa1, setor1);
		Chamado chamado2 = new Chamado(null, setor2.getErro1(), "O sistema é bom demais. Eu amo trabalhar com ele. Me sinto realizado. Porém, há uma pequena falha: Ele não está abrindo.", "Em andamento", null, empresa2, setor2);
